...
echo -e " \033[32;5m             https://github.com/dre/smartmur              \033[0m"
...
ssh -tt $user@$manager1 -i ~/.ssh/$certName sudo su <<EOF
mkdir /mnt/Portainer
curl -L https://raw.githubusercontent.com/JamesTurland/smartmur/main/Docker-Swarm/portainer-agent-stack.yml -o portainer-agent-stack.yml
